export function activateDarkMode() {
	const {
		body, hr, sidebarWhite, hr_card, 
		text_btn, text_span, text_strong, text_nav_link, 
		secondary, bg_gray_100, btn_text_dark, 
		card_border, svg, cardNavLinksIcons, cardNavSpan
	} = getNodes();
...
export function deactivateDarkMode() {
	const {
		body, hr, hr_card, 
		text_btn, text_span_white, text_strong_white, secondary, 
		bg_gray_600, btn_text_white, card_border_dark, svg, 
		navLinks, cardNavLinksIcons, cardNavSpan
	} = getNodes();
...
function getNodes() {
	return {
		body: document.querySelector('.g-sidenav-show.bg-gray-200'),
		hr: document.querySelectorAll("div:not(.sidenav) > hr"),
		sidebarWhite: document.querySelectorAll(".sidenav.bg-white"),
		...
		text_span_white: document.querySelectorAll("span.text-white"),
		...
		btn_text_dark: document.querySelectorAll(".btn.btn-link.text-dark, .btn .ni.text-dark"),
		btn_text_white: document.querySelectorAll(".btn.btn-link.text-white, .btn .ni.text-white"),
		...
		navLinks: document.querySelectorAll(".navbar-main .nav-link, .navbar-main .breadcrumb-item, .navbar-main .breadcrumb-item a, .navbar-main h6"),
		cardNavLinksIcons: document.querySelectorAll(".card .nav .nav-link i"),
		cardNavSpan: document.querySelectorAll(".card .nav .nav-link span"),
	}
}